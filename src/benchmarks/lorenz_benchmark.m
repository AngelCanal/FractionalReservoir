...
%       .do_rollout     (default false)
%       .rollout_steps  (default 500)
%       .ar_lags        (default 10)
%
% Output:
%   bench - standardized benchmark struct. Autonomous rollout is optional,
%           reported separately, and ODE-only.
    ...
    do_rollout = getFieldOrDefault(options, 'do_rollout', false);
    ...
    rhs = @(tt, xx) lorenz_rhs(xx, sigma, rho, beta);
