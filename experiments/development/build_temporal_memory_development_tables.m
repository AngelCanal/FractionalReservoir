...
% Paired descriptive contrasts by model seed. No p-values.
    ...
    row_template = struct( ...
        ...
        'reference_MC_1_25', NaN, ...
        'control_MC_1_25', NaN, ...
        'improvement_MC_1_25', NaN);
    if n_expected == 0
        rows = row_template([]);
    else
    ...
    for is = 1:numel(seeds)
        ...
        for id = 1:size(defs, 1)
            ...
            rows(k).reference_MC_1_25 = ref.memory_capacity_sum_lags_1_25;
            rows(k).control_MC_1_25 = ctrl.memory_capacity_sum_lags_1_25;
            rows(k).improvement_MC_1_25 = ...
