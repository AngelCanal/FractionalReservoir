...
| Mechanism benefit (any ablation superiority) | Complete paired ≥30-seed table, no missing cells, provenance (G7) | `results/revalidated/<full_run>/` | **unsupported** until G7 | No mechanism-superiority claims from pilot |
